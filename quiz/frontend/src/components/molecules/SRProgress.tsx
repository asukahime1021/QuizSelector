...
const SRProgressContainer: React.FC<ContainerProps<ComponentProps, PresenterProps>> = ({presenter, ...props}) => {
    const progress = useCurrentQuizProgressContext().currentQuizProgress.currentQuizProgressMap!!.get(1)?.correctedNum
